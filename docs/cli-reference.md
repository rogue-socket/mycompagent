...
- **Promotion**: specific `error_recovery` lessons are promoted to `best_practice` (Tier 1) after 5+ uses across 3+ domains. Generic one-command advice such as `try click instead` stays in Tier 2.
