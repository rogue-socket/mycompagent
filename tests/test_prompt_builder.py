...
class PromptBuilderTests(unittest.TestCase):
    ...
    def test_system_prompt_guides_generic_requirement_driven_edits(self) -> None:
        ...
        self.assertIn("exact value it already contains", message)
        self.assertIn("value-changing edit", message)
        ...
        self.assertIn("query_miss", message)
        self.assertIn("source_links", message)
        self.assertIn("source_blocks", message)
        self.assertIn("before guessing", message)
